...
async def start(update: Update, context: CallbackContext):
    await context.bot.send_message(chat_id=update.message.chat_id, text='INHA Universitetining GossipBox botiga xush kelibsiz. Kanalga xabar yuborish uchun xabarni shu yerda yozing.')
